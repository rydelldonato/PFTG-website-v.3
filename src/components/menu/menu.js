      ...
      <div className="mainContent">
        ...
        <div>
          <div id="menu" className="d-flex flex-row">
            ...
            <div className="p-2">
              <img alt="over rice" src="over-rice.png" />
            ...
            <div className="p-2">
              <img alt="banh mi" src="banhmi.jpeg" />
